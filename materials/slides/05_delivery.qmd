...
-   Shiny in Production
    ...
    -   Posit Connect runtime settings
-   Managing and Monitoring your content
    -   `connectwidgets` + Connect API
    -   Monitor usage
...
👉 Open the file `materials/activities/activity-06_shiny.qmd`
...
👉 Open the file `materials/activities/activity-07_Connectwidgets.qmd`
:::
