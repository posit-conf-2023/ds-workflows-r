---
title: "01_publish_and_schedule_data_pull"
...
This notebook is a simplified version of the deployed notebook used for the project solution. This notebook is stripped down to only pull the inspection raw data and write a small subset to the database (business data omitted just to keep things speedier). You may find it interesting to browse the project notebook (`materials/project/00_raw_data_scan_db_write.rmd`) to see additional elements that make for a more robust element in the project pipeline. The project solution has these additional features: 
