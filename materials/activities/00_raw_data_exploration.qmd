...
::: {.column width="75%"}
<br> `pointblank` provides data quality assessment and metadata reporting for data frames and database tables. Use the same functions to validate and report on a local data frame or table in a database! 🤯
