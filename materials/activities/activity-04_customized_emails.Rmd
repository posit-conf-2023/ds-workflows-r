...
#note this code chunk is set to `eval=FALSE` so it will be ignored when we deploy this notebook. 
...
email <- blastula::render_connect_email("____")
...
attach_connect_email(email = ____,
                     subject = "____")
