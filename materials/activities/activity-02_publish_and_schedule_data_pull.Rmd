...
print(paste("ℹ️ Info: Downloading Inspection data took", ____))
...
my_df_name <- paste0("inspections_raw_subset_", my_name)
...
print(paste("ℹ️ Info: Writing raw inspection data to database took", ____))
```
...
🛑 Stop here for now. Put your "I'm good" sticky up to let us know
...
The Connect User Guide provides instructions for publishing:
