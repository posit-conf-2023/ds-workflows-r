---
title: "Solutions - Raw Data Exploration"
...
`.csv` using `readr::read_csv()`.[^1]

[^1]: There is a R package called `RSocrata` to interact with SODA,
    however, in our initial testing, the column schemas were
    better-preserved using `readr` as opposed to using the `RSocrata`
    package

Note we are using an environment variable called SOCRATA_APP_TOKEN. This
has been preconfigured for you for the purposes of this workshop.
